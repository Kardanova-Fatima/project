...
public class XlsxReader {
    ...
    public static List<University> readXlsxUniversities(String filePath) throws IOException {
    ...
    public static List<Student> readXlsxStudents(String filePath) throws IOException {
